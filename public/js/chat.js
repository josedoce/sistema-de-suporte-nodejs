...
document.querySelector("#start_chat").addEventListener("click", (event) => {
    ...
    //funçao de exibição de mensagens
    socket.on('client_list_all_messages',(messages)=>{
        //populando caixa de mensagem com o mustache
    ...
    //função de recebimento de mensagens do ajudante
...
//função de envio de mensagens para o ajudante
